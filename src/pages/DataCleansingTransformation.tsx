...
export const DataCleansingTransformation = () => {
  ...
  return (
    <>
      ...
      <section
        data-w-id="91e6c13d-516b-9c6c-e0d3-35e18cce7781"
      ...
      >
        <div className="about-three-container about-three-testimonial-container">
          <div className="home-one-hero-text-one about-three-hero-text-one-box">
            ...
            <div className="home-one-hero-text-bold-two about-two-applycation-text-one">
              Testimonials
            </div>
          </div>
          <h2 className="about-three-testimonial-head-three">
        ...
        <div
          ...
          style={{
            ...
            transform: 'translate3d(34px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
            transformStyle: 'preserve-3d',
          }}
        >
          <div className="about-three-testimonial-card-section-one">
            <div className="about-three-testimonial-card-one">
              <div className="about-three-testimonial-card-one-inside">
                <div className="about-three-testimonial-card-user">
                  <div className="about-three-testimonial-head-three">
                    <div className="text-block-nine">
                      <strong>Sarah T</strong>
                    </div>
                    <div className="text-block-eight about-three-card-text-size">
                      <strong>Marketing Manager</strong>
                    </div>
                  </div>
                </div>
                <img
                  src="https://cdn.prod.website-files.com/665075d333d845b30969fece/665075d333d845b3096a002d_Comas.webp"
                  alt=""
                  width="48.5"
                  height="48"
              ...
              <p className="about-three-testimonial-card-paragraph">
                Working with <strong>Clymin</strong> has transformed our <strong>e-commerce</strong>{' '}
                business. Their <strong>real-time insights</strong> into <strong>market trends</strong>{' '}
                and <strong>competitor pricing</strong> boosted our <strong>revenue</strong> by{' '}
                <strong>20%</strong>. The team's <strong>responsiveness</strong> and{' '}
                <strong>dedication</strong> are impressive. Highly recommend!
              </p>
            </div>
            <div className="about-three-testimonial-card-one">
              <div className="about-three-testimonial-card-one-inside">
                <div className="about-three-testimonial-card-user">
                  <div className="about-three-testimonial-head-three">
                    ...
                    <div className="about-three-card-text-size">
              ...
              <p className="about-three-testimonial-card-paragraph">
                <strong>Clymin's data extraction services</strong> have revolutionized our analysis. As
                a <strong>financial analyst</strong>, having <strong>accurate data</strong> is crucial.
                Clymin's <strong>intuitive tools</strong> and <strong>top-notch team</strong> improved
                our <strong>decision-making speed by 25%.</strong>
              </p>
            </div>
          </div>
          <div className="about-three-testimonial-card-section-one">
            <div className="about-three-testimonial-card-one">
              <div className="about-three-testimonial-card-one-inside">
                <div className="about-three-testimonial-card-user">
                  <div className="about-three-testimonial-head-three">
                    ...
                    <div className="about-three-card-text-size">
                      <strong>Senior Financial Analyst</strong>
                    </div>
                  </div>
                </div>
                <img
              ...
              <p className="about-three-testimonial-card-paragraph">
                As a <strong>social media manager</strong>, I rely on <strong>Clymin's scraping solutions</strong>{' '}
                for detailed data, improving <strong>audience engagement by 40%</strong>. Their team is
                responsive and supportive. <strong>Clymin</strong> is key to our{' '}
            ...
            <div className="about-three-testimonial-card-one">
              ...
              <p className="about-three-testimonial-card-paragraph">
                Using <strong>Clymin's travel data intelligence</strong> for over a year has
                transformed our operations. Automating hotel reviews and pricing scraping improved{' '}
                <strong>competitive rate adjustments by 20%</strong>. Their services are{' '}
                <strong>reliable</strong> and <strong>efficient</strong>.
              </p>
            </div>
          </div>
          <div className="about-three-testimonial-card-section-one">
              ...
              <div className="about-three-testimonial-card-one-inside">
                ...
                <div className="about-three-testimonial-card-user">
                  <div className="about-three-testimonial-head-three">
                    ...
                    <div className="about-three-card-text-size">
                      <strong>Real Estate Consultant</strong>
                    </div>
                  </div>
                </div>
              </div>
              <p className="about-three-testimonial-card-paragraph">
                <strong>Clymin</strong> made <strong>real estate data</strong> collection effortless,
                providing comprehensive property listings and market data. This improved our data
                collection efficiency by <strong>35%</strong>. The team is professional, knowledgeable,
            ...
            <div className="about-three-testimonial-card-one">
              ...
              <p className="about-three-testimonial-card-paragraph">
                <strong>Clymin </strong>exceeded our expectations with their{' '}
                <strong>competitive intelligence</strong> services. Their web scraping tools offered
                detailed insights into competitors' strategies, enhancing our competitive strategy
                development by <strong>30%. </strong>The tools are easy to use and provide valuable
                data
              </p>
            </div>
          </div>
